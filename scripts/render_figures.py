...
def render_throughput_chart():
    models = [
        "MLP (Baseline)", "LowRankKAN", "ReLUKAN (Tent)", "WavKAN", 
        "JacobiKAN", "MultKAN (2.0)", "FastKAN (RBF)", "FourierKAN", 
        "ChebyKAN", "B-Spline KAN"
    ]
    throughput = [
        3016866, 1236498, 1175727, 1041365,
        1032210, 1008141, 896675, 733221,
        468365, 428156
    ]
    latency = [
        0.339, 0.828, 0.871, 0.983,
        0.992, 1.016, 1.142, 1.397,
        2.186, 2.392
    ]
    ...
    # Colors
    colors = ["#94A3B8"] + ["#3B82F6", "#10B981", "#8B5CF6", "#EC4899", "#F59E0B", "#06B6D4", "#6366F1", "#F97316", "#EF4444"]
...
def render_iso_stress_chart():
    ...
    t1 = [0.185, 0.303, 0.313, 0.355, 0.376, 0.433, 0.357, 0.359, 0.423]
    # Task 2 (Non-Smooth, ~500p)
    t2 = [0.027, 0.024, 0.025, 0.016, 0.019, 0.023, 0.035, 0.051, 0.044]

...
- **[metal-KANs (v0.3.0)](https://github.com/Shuril/metal-kans)**: Чистый Metal Shading Language (MSL) с аппаратным матричным умножением на сопроцессоре Apple AMX и векторными SIMD базисными кернелами.

...
- **[metal-KANs (v0.3.0)](https://github.com/Shuril/metal-kans)**: Pure Metal Shading Language (MSL) with Apple AMX coprocessor matrix multiplication and SIMD basis kernels.
